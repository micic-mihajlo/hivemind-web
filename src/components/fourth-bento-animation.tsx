...
const boxConfigs: BoxConfig[] = [
  {
    title: "Inbox Triage",
    className: "bg-[#075056] text-white",
  },
  {
    title: "Calendar Routing",
    className: "bg-[#075056]/40 text-white",
  },
  {
    title: "Follow-Up Queue",
    className:
      "bg-[#075056]/20 border border-[#075056] border-dashed text-[#075056]",
  },
];
...
export function FourthBentoAnimation({
  ...
  return (
    ...
    >
      ...
      />
      <motion.div
        className="absolute top-14 bg-black dark:bg-accent h-6 z-20 flex items-center justify-center text-xs p-2 rounded-md shadow-[0px_2.2px_6.6px_0px_rgba(7,80,86,0.10),0px_1.1px_2.2px_0px_rgba(7,80,86,0.16),0px_0px_0px_1.1px_rgba(7,80,86,0.16),0px_1.1px_0px_0px_rgba(255,255,255,0.20)_inset,0px_4.4px_6.6px_0px_rgba(255,255,255,0.01)_inset]"
        style={{
          x: smoothX,
          translateX: "-50%",
        }}

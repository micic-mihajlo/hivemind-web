  ...
  return (
    <Reasoning>
      <ReasoningContent className="">
        <ReasoningResponse
          text={reasoningText}
          className="text-accent-foreground dark:text-accent-foreground [&_*]:!text-accent-foreground"
        />
      </ReasoningContent>
    </Reasoning>
  );
    ...
    >
      ...
      >
        <div className="flex items-end justify-end gap-3">
          <motion.div
            className="max-w-[280px] bg-[#075056] text-white p-4 rounded-2xl ml-auto shadow-[0_0_10px_rgba(0,0,0,0.05)]"
            ...
            <AnimatePresence mode="wait">
              {!shouldAnimate ? (
                ...
                <motion.div
                  key="response"
                  layout
                  className="absolute left-0 top-0 md:min-w-[300px] min-w-[220px] p-4 bg-accent border border-accent-foreground/20 rounded-xl shadow-[0_0_10px_rgba(0,0,0,0.05)]"
